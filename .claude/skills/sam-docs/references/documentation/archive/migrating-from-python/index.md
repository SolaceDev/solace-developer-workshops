...
description: A 12-month aid for existing Python Agent Mesh users moving to the current Solace Agent Mesh release. Sunset ~2027-05.
sidebar_position: 0
---

# Migrating From Python

This section exists as a 12-month aid for users already running Python Agent Mesh. Sunset target: **~2027-05**. New users can skip this section entirely.
