...
This section covers everything you need to get Agent Mesh running. If you haven't yet chosen an installation option, see [Choosing Your Installation Path](../getting-started/choosing-your-path.md).

## Before You Begin

- [Before You Begin](./before-you-begin.md)—Prerequisites that apply across all installation options.
...
- [Configuring Agent Mesh](./configure.md)—Configure your event broker connection, LLM provider, storage, and authentication. Does not apply to the desktop bundle.
- [Monitoring Your Deployment](./monitor.md)—Set up logging, metrics, and health checks.
- [Troubleshooting Your Installation](./troubleshoot.md)—Diagnose and resolve common installation and deployment issues.
