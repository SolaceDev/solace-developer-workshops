...
<div align="center">
    <img src="../images/sam/sam-plugin-catalog.png" alt="Solace Agent Mesh Plugin Catalog" width="80%" style="box-shadow: 0 4px 8px rgb(0,200,130); border-radius: 8px;">
</div>
...
<div align="center">
    <img src="../images/sam/sam-new-agents.png" alt="Solace Agent Mesh New Agents" width="80%" style="box-shadow: 0 4px 8px rgb(0,200,130); border-radius: 8px;">
</div>
...
<div align="center">
    <img src="../images/sam/100-sam-info-agents-new.png" alt="Solace Agent Mesh Info Agents" width="80%" style="box-shadow: 0 4px 8px rgb(0,200,130); border-radius: 8px;">
</div>
